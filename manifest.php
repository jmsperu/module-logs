...
$description="Module for Accessign Gibbon Access Logs" ; //Short text description
...
$author="James Peru" ; //Your name
$url="https://xcobean.org" ; //Your URL

//Module tables
$moduleTables[0]="" ; //One array entry for every database table you need to create. Convention dictates that you preface the table name with the module name, to keep the db neat. 
$moduleTables[1]="" ; //Other sql can be run, but resulting data will not be cleaned up on uninstall.
